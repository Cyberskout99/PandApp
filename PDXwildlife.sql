...
Sex VARCHAR (5),
DOB date NOT NULL,
Age numeric, /* Caluclated Field: CurrDate() - DOB */
DeathDate date,
DeathAge numeric, /* Calculated Field: DeathDate-DOB (in years) */,
Surv1yr boolean, /* Calculated Field:  DeathAge =< 1 year (True/False) */
Surv2yr boolean, /* Calculated Field:  DeathAge =< 2 year (True/False) */
Surv3yr boolean, /* Calculated Field:  DeathAge =< 3 year (True/False) */
SurvAdult boolean, /*Calculated Field: Age > 3 year (True/False) */
...
BreedAge numeric (4), /*2 decimals*/ 
BreedNatSuc varchar (1), /*Yes, No, Unknown */
ParityDate date, /*Column AB*/
ParityAge numeric (12), /*2 decimals*/
TotalRepYears numeric, /* calculated field, (currDate-ParityDate)/365)*/
TotalLifetimeCubs numeric, /*calculated field, sum of distinct panda ID */
AvgReproCubs numeric) /* calculated field: TotalLifetimeCubs/TotalRepYears */
;
...
LitterSeq int, /*sequence of litter, i.e., 1st, 2nd, 3rd, etc.)*/
LitterSize int,
LitterSire varchar (3), /* yes/no/unk/S */
LitterDate date,
LitterSurvPerc int, /* Calculated field - Leave this for analysis ?*/
